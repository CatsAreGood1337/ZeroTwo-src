package me.сс.zerotwo.client.modules;
...
class Module extends Client {
    ...
    void setDisplayName ( String name ) {
        Module module = ZeroTwo.moduleManager.getModuleByDisplayName ( name );
        Module originalModule = ZeroTwo.moduleManager.getModuleByName ( name );
