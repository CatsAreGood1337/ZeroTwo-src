...
class Nametags
    ...
    private final Setting < Float > scaling = this.register ( new Setting < Float > ( "Size" , Float.valueOf ( 0.8f ) , Float.valueOf ( 0.1f ) , Float.valueOf ( 20.0f ) ) );
    ...
    String getDisplayTag ( EntityPlayer player ) {
        ...
        if ( this.totemPops.getValue ( ).booleanValue ( ) ) {
            popStr = popStr + ZeroTwo.totemPopManager.getTotemPopString ( player );
        }
        String idString = "";
