...
public class BoatFly
    ...
    public Setting<Double> verticalSpeed = this.register(new Setting<Double>("VerticalSpeed", 1.0, 1.0, 20.0));
    public Setting<Boolean> noKick = this.register(new Setting<Boolean>("No-Kick", false));
