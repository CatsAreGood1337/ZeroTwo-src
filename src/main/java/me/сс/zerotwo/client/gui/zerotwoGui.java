package me.сс.zerotwo.client.gui;
...
import me.сс.zerotwo.client.gui.components.items.buttons.ModuleButton;
import me.сс.zerotwo.client.gui.components.items.buttons.Slider;
...
public class zerotwoGui extends GuiScreen {
    ...
    private ResourceLocation zerotwoimg = new ResourceLocation("textures/zerotwo.png");
    private static zerotwoGui zerotwoGui;
    private final ArrayList<Component> components = new ArrayList<>();
    private static zerotwoGui INSTANCE = new zerotwoGui();
    ...
    public static zerotwoGui getInstance() {
        if(INSTANCE == null) {
            INSTANCE = new zerotwoGui();
        }
        return INSTANCE;
    }
    ...
    public static zerotwoGui getClickGui() {
        return getInstance();
    }
        ...
        for(Module.Category category : ZeroTwo.moduleManager.getCategories()) {
            components.add(new Component(category.getName(), x += 115 , 4, true) {
                ...
                public void setupItems() {
                    ZeroTwo.moduleManager.getModulesByCategory(category).forEach(module -> {
                        if (!module.hidden) {
