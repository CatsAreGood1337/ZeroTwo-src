...
class RenderUtil implements Util {
    ...
    void drawText ( BlockPos pos , String text ) {
        ...
        GlStateManager.disableDepth ( );
        GlStateManager.translate ( - ( ZeroTwo.textManager.getStringWidth ( text ) / 2.0d ) , 0 , 0 );
        ZeroTwo.textManager.drawStringWithShadow ( text , 0 , 0 , 0xFFAAAAAA );
        GlStateManager.popMatrix ( );
    }
    ...
    void drawText ( BlockPos pos , String text , Boolean shadow ) {
        ...
        GlStateManager.disableDepth ( );
        GlStateManager.translate ( - ( ZeroTwo.textManager.getStringWidth ( text ) / 2.0d ) , 0 , 0 );
        ZeroTwo.textManager.drawString ( text , 0 , 0 , 0xFFAAAAAA , shadow );
        GlStateManager.popMatrix ( );
    }
