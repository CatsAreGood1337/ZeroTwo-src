...
import me.сс.zerotwo.client.modules.player.FakePlayer;
import me.сс.zerotwo.client.modules.player.Freecam;
...
class EntityUtil implements Util {
   ...
   public static
    ...
    boolean isntValid ( Entity entity , double range ) {
        return entity == null || isDead ( entity ) || entity.equals ( mc.player ) || ( entity instanceof EntityPlayer && ZeroTwo.friendManager.isFriend ( entity.getName ( ) ) ) || mc.player.getDistanceSq ( entity ) > MathUtil.square ( range );
    }
    ...
    Color getColor ( Entity entity , int red , int green , int blue , int alpha , boolean colorFriends ) {
        ...
        if ( entity instanceof EntityPlayer ) {
            if ( colorFriends && ZeroTwo.friendManager.isFriend ( (EntityPlayer) entity ) ) {
    ...
    Map < String, Integer > getTextRadarPlayers ( ) {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            output.put ( healthSB + " " + ( ZeroTwo.friendManager.isFriend ( player ) ? TextUtil.AQUA : TextUtil.RESET ) + player.getName ( ) + " " + distanceSB + " " + TextUtil.WHITE + ZeroTwo.totemPopManager.getTotemPopString ( player ) + ZeroTwo.potionManager.getTextRadarPotion ( player ) , (int) mc.player.getDistance ( player ) );
